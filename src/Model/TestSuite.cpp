...
namespace allure { namespace model {
	...
	std::string TestSuite::getHistoryId() const
	{
		return m_historyId;
	}

	std::string TestSuite::getTestCaseId() const
	{
		return m_testCaseId;
	}
	...
	void TestSuite::setHistoryId(const std::string& historyId)
	{
		m_historyId = historyId;
	}

	void TestSuite::setTestCaseId(const std::string& testCaseId)
	{
